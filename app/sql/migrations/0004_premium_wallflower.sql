CREATE TYPE "public"."type" AS ENUM('follow', 'review', 'reply', 'mention');--> statement-breakpoint
...
ALTER TABLE "notifications" ADD CONSTRAINT "notifications_post_id_community_posts_post_id_fk" FOREIGN KEY ("post_id") REFERENCES "public"."community_posts"("post_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
